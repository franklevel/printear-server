...
var AppController = /** @class */ (function () {
    ...
    AppController.prototype.getToken = function (code) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.appService.getToken(code)];
            });
        });
    };
    ...
    __decorate([
        ...
        __param(1, common_1.Param('storeId', common_1.ParseIntPipe))
    ], AppController.prototype, "getProductById");
    __decorate([
        common_1.Post('/auth/:code'),
        __param(0, common_1.Param('code'))
    ], AppController.prototype, "getToken");
    __decorate([
        common_1.Get('/product/:storeId'),
        __param(0, common_1.Param('storeId', common_1.ParseIntPipe))
